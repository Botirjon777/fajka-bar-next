          ...
          <div className="flex gap-4 flex-1">
             <div className="relative flex-1 sm:w-64">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-2xl py-4 pl-14 pr-6 text-[10px] font-black tracking-widest uppercase focus:border-primary/50 transition-all outline-none text-white font-[inherit]"
                />
             </div>
             ...
             <div className="relative">
                ...
                <select
                  ...
                  className="bg-white/5 border border-white/5 rounded-2xl py-4 pl-14 pr-10 text-[10px] font-black tracking-widest uppercase appearance-none cursor-pointer outline-none focus:border-primary/50 text-white font-[inherit]"
                >
  ...
  return (
    <div className="group p-4 md:p-6 bg-bg-card border border-white/5 hover:border-white/10 rounded-2xl md:rounded-[2.5rem] transition-all flex items-center justify-between">
      <div className="flex items-center gap-6 flex-1">
         ...
         <div>
            <h4 className="text-lg font-bold group-hover:text-primary transition-colors text-white">{product.name.en}</h4>

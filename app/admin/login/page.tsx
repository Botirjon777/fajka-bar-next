  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 selection:bg-primary selection:text-black">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/5 blur-[120px] rounded-full delay-1000" />
      </div>
      ...
      >
        <div className="bg-bg-card border border-white/10 p-10 md:p-14 rounded-[4rem] shadow-2xl backdrop-blur-3xl relative overflow-hidden group">
          ...
          <header className="mb-12 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-primary/5 border border-primary/20 text-primary mb-6 group-hover:scale-110 transition-transform duration-500">
               <ShieldCheck size={32} />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-black font-black uppercase tracking-[0.2em] py-5 rounded-3xl shadow-[0_15px_30px_rgba(212,175,55,0.3)] hover:brightness-110 hover:shadow-primary/40 disabled:opacity-50 transition-all flex items-center justify-center gap-3 active:scale-95"
            >
              {loading ? (

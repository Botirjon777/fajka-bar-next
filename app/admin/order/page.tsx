        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            {viewPath.level !== "root" && (
              <button 
                onClick={goBack}
                className="p-2 rounded-xl bg-white/5 text-white/40 hover:text-primary hover:bg-primary/10 transition-all"
              >
                <ChevronLeft size={20} />
              </button>
            )}
    ...
    <div className="bg-bg-card border border-white/10 rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl">
      <div className="p-3 md:p-4 bg-white/2 border-b border-white/5 flex justify-between items-center px-5 md:px-8">
        ...
        <button
          onClick={onSave}
          disabled={saving}
          className="bg-primary/10 text-primary hover:bg-primary hover:text-black font-black uppercase tracking-[0.2em] px-4 py-2 rounded-xl transition-all flex items-center gap-2 text-[9px] disabled:opacity-50"
        >
          ...
          {items.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-3 md:gap-6 flex-1">
                <div className="text-white/10 group-hover:text-primary transition-colors cursor-grab active:cursor-grabbing shrink-0">
                ...
                >
                  <h4 className="text-sm md:text-lg font-serif font-black italic text-white group-hover:text-primary transition-colors">
                ...
                {onNavigate && (
                    <button 
                        ...
                        className="ml-auto opacity-0 group-hover:opacity-100 p-2 text-white/20 hover:text-primary transition-all"
                    >
